 ...
 * 描述：
 */
public class FutKafkaConsumer01 extends Thread{

    KafkaConsumer<Integer,String> consumer;
    String topic;

    public FutKafkaConsumer01(String topic){
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG,"fut-gid01");
    ...
    public static void main(String[] args) {
        new FutKafkaConsumer01("fut_test01").start();
    }
}
